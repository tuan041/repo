...
class XemphimProvider : MainAPI() {
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        ...
        return document.select("div.item.col-lg-2.col-md-3.col-sm-4.col-6").mapNotNull {
                ...
                val titleHeader = if (main.selectFirst("p:nth-child(1)").isNotEmpty())
                    main.selectFirst("p:nth-child(1)") else main.selectFirst("p.subtitle:nth-child(2)") ?: return@mapNotNull null
